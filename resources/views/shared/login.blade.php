...
<head>
    ...
    <title>{{ config('app.name', 'Biddart') }} - Event Staff Login</title>
        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600">
                    Enter your shared event credentials
                </p>
            </div>
            
            <form class="mt-8 space-y-6" action="{{ route('shared.login.post') }}" method="POST">
                @csrf
